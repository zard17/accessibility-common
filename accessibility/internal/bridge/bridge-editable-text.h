#ifndef ACCESSIBILITY_INTERNAL_ACCESSIBILITY_BRIDGE_EDITABLE_TEXT_H
#define ACCESSIBILITY_INTERNAL_ACCESSIBILITY_BRIDGE_EDITABLE_TEXT_H
...
/**
 * @brief The BridgeEditableText class is to correspond with Accessibility::EditableText.
 */
...
protected:
   ...
   */
  std::shared_ptr<Accessibility::EditableText> FindSelf() const;

public:
  /**
   * @copydoc Accessibility::EditableText::CopyText()
   */
  DBus::ValueOrError<bool> CopyText(int32_t startPosition, int32_t endPosition);

  /**
   * @copydoc Accessibility::EditableText::CutText()
   */
  DBus::ValueOrError<bool> CutText(int32_t startPosition, int32_t endPosition);

  /**
   * @copydoc Accessibility::EditableText::DeleteText()
   */
  DBus::ValueOrError<bool> DeleteText(int32_t startPosition, int32_t endPosition);

  /**
   * @copydoc Accessibility::EditableText::InsertText()
   */
  ...
  /**
   * @copydoc Accessibility::EditableText::SetTextContents()
   */
  DBus::ValueOrError<bool> SetTextContents(std::string newContents);
};

#endif // ACCESSIBILITY_INTERNAL_ACCESSIBILITY_BRIDGE_EDITABLE_TEXT_H
