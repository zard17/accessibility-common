...
bool Accessibility::Component::IsAccessibleContainingPoint(Accessibility::Point point, Accessibility::CoordinateType type) const
{
  return false;
}

Accessibility::Accessible* Accessibility::Component::GetAccessibleAtPoint(Accessibility::Point point, Accessibility::CoordinateType type)
{
  return nullptr;
}
