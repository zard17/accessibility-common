#ifndef ACCESSIBILITY_INTERNAL_ACCESSIBILITY_BRIDGE_APPLICATION_H
#define ACCESSIBILITY_INTERNAL_ACCESSIBILITY_BRIDGE_APPLICATION_H
...
/**
 * @brief The BridgeApplication class is to correspond with Accessibility::Application.
 *
...
protected:
   ...
   */
  std::shared_ptr<Accessibility::Application> FindSelf() const;
...
#endif // ACCESSIBILITY_INTERNAL_ACCESSIBILITY_BRIDGE_APPLICATION_H
