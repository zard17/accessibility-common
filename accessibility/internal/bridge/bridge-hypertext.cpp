...
{
  return FindCurrentObjectWithInterface<Accessibility::AtspiInterface::HYPERTEXT>();
}
...
DBus::ValueOrError<Accessibility::Accessible*> BridgeHypertext::GetLink(int32_t linkIndex)
{
