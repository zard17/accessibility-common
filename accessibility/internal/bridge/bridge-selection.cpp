...
{
  return FindCurrentObjectWithInterface<Accessibility::AtspiInterface::SELECTION>();
}
...
DBus::ValueOrError<Accessibility::Accessible*> BridgeSelection::GetSelectedChild(int32_t selectedChildIndex)
{
