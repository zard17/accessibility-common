...
{
  return FindCurrentObjectWithInterface<Accessibility::AtspiInterface::HYPERLINK>();
}
...
DBus::ValueOrError<Accessibility::Accessible*> BridgeHyperlink::GetAnchorAccessible(int32_t anchorIndex)
{
