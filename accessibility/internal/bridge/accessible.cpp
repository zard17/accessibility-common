...
bool Accessible::IsAccessibleContainingPoint(Point point, Accessibility::CoordinateType type) const
{
...
Accessible* Accessible::GetAccessibleAtPoint(Point point, Accessibility::CoordinateType type)
{
