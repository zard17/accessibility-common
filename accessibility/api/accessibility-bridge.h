 ...
 */
struct ACCESSIBILITY_API Bridge
{
  ...
  /**
   * @brief Gets the accessible object associated with given object ID from the bridge.
   */
  virtual std::shared_ptr<Accessible> GetAccessible(uint32_t objectId) const = 0;
   ...
   */
  virtual void RegisterDefaultLabel(Accessible* accessible) = 0;
   ...
   */
  virtual void UnregisterDefaultLabel(Accessible* accessible) = 0;
   ...
   */
  virtual void WindowCreated(Accessible* windowRoot) = 0;
   ...
   */
  virtual void WindowShown(Accessible* windowRoot) = 0;
   ...
   */
  virtual void WindowHidden(Accessible* windowRoot) = 0;
   ...
   */
  virtual void WindowFocused(Accessible* windowRoot) = 0;
   ...
   */
  virtual void WindowUnfocused(Accessible* windowRoot) = 0;
   ...
   */
  virtual void WindowMinimized(Accessible* windowRoot) = 0;
   ...
   */
  virtual void WindowRestored(Accessible* windowRoot, WindowRestoreType detail) = 0;
   ...
   */
  virtual void WindowMaximized(Accessible* windowRoot) = 0;
   ...
   */
  virtual bool EmitKeyEvent(KeyEvent keyEvent, std::function<void(KeyEvent, bool)> callback) = 0;
   ...
   *
   * @see Accessibility::DummyBridge
   * @see Accessibility::Bridge::EnableAutoInit
   */
   ...
   *
   * @see Accessibility::Bridge::DisableAutoInit
   * @see Accessibility::Bridge::AddTopLevelWindow
   * @see Accessibility::Bridge::SetApplicationName
   */
  ...
  static Signal<>& EnabledSignal()
  {
    return mEnabledSignal;
  }

  static Signal<>& DisabledSignal()
  {
    return mDisabledSignal;
  }

  static Signal<>& ScreenReaderEnabledSignal()
  {
    return mScreenReaderEnabledSignal;
  }

  static Signal<>& ScreenReaderDisabledSignal()
  {
...
protected:
  ...
  {
    std::string                           mBusName;
    Accessible*                           mCurrentlyHighlightedAccessible{nullptr};
  ...
  inline static Signal<> mEnabledSignal;
  inline static Signal<> mDisabledSignal;
  inline static Signal<> mScreenReaderEnabledSignal;
  inline static Signal<> mScreenReaderDisabledSignal;
