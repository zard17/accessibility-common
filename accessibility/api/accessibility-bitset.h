#ifndef ACCESSIBILITY_BITSET_H
#define ACCESSIBILITY_BITSET_H
...
public:
  ...
  using ReferenceType = Internal::BitReference;     ///< Accessibility::Internal::BitReference
  using ElementType   = ReferenceType::ElementType; ///< Accessibility::Internal::BitReference::ElementType
  using IndexType     = ReferenceType::IndexType;   ///< Accessibility::Internal::BitReference::IndexType
 ...
 * @see Accessibility::Accessible::GetRoles
 */
...
public:
  ...
  using IndexType     = typename BitSet<N>::IndexType;     ///< Accessibility::BitSet<N>::IndexType
  using ReferenceType = typename BitSet<N>::ReferenceType; ///< Accessibility::BitSet<N>::ReferenceType
  ...
  /**
   * @copydoc Accessibility::BitSet::operator~() const
   */
  ...
  /**
   * @copydoc Accessibility::BitSet::operator|(const BitSet&) const
   */
  ...
  /**
   * @copydoc Accessibility::BitSet::operator[]()
   */
