#ifndef ACCESSIBILITY_EDITABLE_TEXT_H
#define ACCESSIBILITY_EDITABLE_TEXT_H
 ...
 *
 * @see Accessibility::EditableText
 */
class ACCESSIBILITY_API EditableText : public IAccessibilityFeature
{
public:
  /**
...
#endif // ACCESSIBILITY_EDITABLE_TEXT_H
