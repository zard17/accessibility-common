#ifndef ACCESSIBILITY_VALUE_H
#define ACCESSIBILITY_VALUE_H
 ...
 */
class ACCESSIBILITY_API Value : public IAccessibilityFeature
{
public:
  /**
   ...
   * @see Toolkit::DevelControl::AppendAccessibilityAttribute()
   */
