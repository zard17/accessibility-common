#ifndef ACCESSIBILITY_COMPONENT_H
#define ACCESSIBILITY_COMPONENT_H
 ...
 */
class ACCESSIBILITY_API Component
{
public:
  /**
   ...
   *
   * @see Accessibility::ComponentLayer
   */
...
#endif // ACCESSIBILITY_COMPONENT_H
