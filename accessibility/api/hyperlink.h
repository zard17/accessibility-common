#ifndef ACCESSIBILITY_HYPERLINK_H
#define ACCESSIBILITY_HYPERLINK_H
 ...
 */
class ACCESSIBILITY_API Hyperlink : public IAccessibilityFeature
{
public:
  /**
...
#endif // ACCESSIBILITY_HYPERLINK_H
