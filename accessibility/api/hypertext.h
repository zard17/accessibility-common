#ifndef ACCESSIBILITY_HYPERTEXT_H
#define ACCESSIBILITY_HYPERTEXT_H
 ...
 */
class ACCESSIBILITY_API Hypertext : public IAccessibilityFeature
{
public:
  /**
...
#endif // ACCESSIBILITY_HYPERTEXT_H
