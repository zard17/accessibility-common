#ifndef ACCESSIBILITY_SELECTION_H
#define ACCESSIBILITY_SELECTION_H
 ...
 */
class ACCESSIBILITY_API Selection : public IAccessibilityFeature
{
public:
  /**
   ...
   * @return true on success, false otherwise
   *
   * @see Accessibility::Selection::DeselectChild
   */
   ...
   * @return true on success, false otherwise
   *
   * @see Accessibility::Selection::DeselectSelectedChild
   */
...
#endif // ACCESSIBILITY_SELECTION_H
