#ifndef ACCESSIBILITY_APPLICATION_H
#define ACCESSIBILITY_APPLICATION_H
 ...
 */
class ACCESSIBILITY_API Application : public IAccessibilityFeature
{
public:
  /**
...
#endif // ACCESSIBILITY_APPLICATION_H
