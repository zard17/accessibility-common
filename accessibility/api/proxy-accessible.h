#ifndef ACCESSIBILITY_PROXY_ACCESSIBLE_H
#define ACCESSIBILITY_PROXY_ACCESSIBLE_H
 ...
 */
class ACCESSIBILITY_API ProxyAccessible : public Accessible
{
public:
  ProxyAccessible()
  : mAddress{},
...
#endif // ACCESSIBILITY_PROXY_ACCESSIBLE_H
