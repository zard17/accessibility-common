#ifndef ACCESSIBILITY_ACCESSIBLE_H
#define ACCESSIBILITY_ACCESSIBLE_H
...
#include <accessibility/api/component.h>
 ...
 */
class ACCESSIBILITY_API Accessible : public Component
{
public:
   ...
   *
   * @see Accessibility::State
   * @see Accessibility::ArrayBitset
   */
...
public:
   ...
   *
   * @return The currently highlighted accessible, or nullptr
   */
  static Accessible* GetCurrentlyHighlightedAccessible();

  /**
   * @brief Sets the currently highlighted accessible.
   *
   * @param[in] accessible The accessible to highlight
   */
  static void SetCurrentlyHighlightedAccessible(Accessible* accessible);
...
#endif // ACCESSIBILITY_ACCESSIBLE_H
