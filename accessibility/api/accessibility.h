#ifndef ACCESSIBILITY_ACCESSIBILITY_H
#define ACCESSIBILITY_ACCESSIBILITY_H
/*
...
// INTERNAL INCLUDES
#include <accessibility/api/accessibility-bitset.h>
 ...
 *
 * @see Accessibility::Accessible::GetInterfaceName()
 ...
 * {
 *   using Type = Accessibility::Accessible;
 * };
 */
 ...
 * @code Accessibility::Accessible @endcode. Not all AT-SPI interfaces have native C++
 ...
 * @see Accessibility::Accessible::GetAddress
 */
class ACCESSIBILITY_API Address
{
public:
  Address() = default;
 ...
 */
struct ACCESSIBILITY_API Point
{
  int x = 0;
  int y = 0;
 ...
 * @see Accessibility::Text::GetTextAtOffset
 * @see Accessibility::Text::GetRangeOfSelection
 */
struct ACCESSIBILITY_API Range
{
 ...
 * @see Accessibility::Accessible::DoGesture
 */
struct ACCESSIBILITY_API GestureInfo
{
  GestureInfo() = default;
 ...
 *
 * @see Accessibility::Accessible::Accessible
 * @see Accessibility::Accessible::RelationType
 */
struct ACCESSIBILITY_API Relation
{
...
struct ACCESSIBILITY_API ActionInfo
{
  ActionInfo() = default;
  ActionInfo(ActionType type, Accessible* target)
  : type{type},
    target{target}
  {
  }
...
#endif // ACCESSIBILITY_ACCESSIBILITY_H
